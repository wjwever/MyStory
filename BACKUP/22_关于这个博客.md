...
## 这个博客的来历
最近想写点博客，把以前看过的一些东西记录记录起来，我对写博客凭条的要求主要有
* 简洁
* 完善的markdown支持

后来陆陆续续的尝试了一些平台，用的比较好有知乎，简书。
但这两个平台有个共同的缺点就是，个性化推送太多了，特别容易分散注意力。
后来在知乎上搜索了一下，发现了 https://github.com/yihong0618/gitblog 这个项目，被他的简洁和纯粹所打动，所以就把他给拷贝过来了，使用了大约一个月，感觉用起来非常舒服，点赞！
## 使用方法
* 前提：申请github key
* clone这个代码仓
...
---
<img width="786" alt="image" src="https://github.com/wjwever/gitblog/assets/50772316/01873294-59be-4301-877d-e32f5fefdf98">
* 使用
